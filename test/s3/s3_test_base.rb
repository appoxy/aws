class S3TestBase < Test::Unit::TestCase
  ...
  require_relative '../sdb/faraday_em_adapter'
  def setup
    ...
    @s3_em = Aws::S3Interface.new(TestCredentials.aws_access_key_id, TestCredentials.aws_secret_access_key, :executor=>@executor)
